...
buttons=InlineKeyboardMarkup(
        [
            ...
            [
                InlineKeyboardButton("Source Code", url="https://github.com/Shobit51/public-forward-bot"),
                InlineKeyboardButton("Updates Channel", url="https://t.me/Dhruv04_bot")
            ]
        ]
        )
...
async def cb_abt(bot, cb):
    ...
    reply_markup=InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("Source", url="https://github.com/Shobit51/public-forward-bot"),
            ]
        ]
    )
    )
